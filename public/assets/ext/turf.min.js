! function(t, e) {
    ...
    function Cn(t, e, n, r, i, o, s) {
        if (t) {
            ...
            for (var a, u, l = t; t.prev !== t.next;)
                if (a = t.prev, u = t.next, o ? Ln(t, r, i, o) : Pn(t)) e.push(a.i / n), e.push(t.i / n), e.push(u.i / n), Vn(t), t = u.next, l = u.next;
                else if ((t = u) === l) {
    ...
    function Gr(t) {
        for (var e = function(t) {
            ...
            if ("Point" === u.type) n.geometry.coordinates[0] === u.coordinates[0] && n.geometry.coordinates[1] === u.coordinates[1] && (r = !0);
                ...
                for (s = 0; !l && s < u.coordinates.length - 1;) qr(n.geometry.coordinates[0], n.geometry.coordinates[1], u.coordinates[s][0], u.coordinates[s][1], u.coordinates[s + 1][0], u.coordinates[s + 1][1]) && (l = !0, r = !0), s++;
    ...
    Vs.prototype.init = function() {
        ...
        remove: function(t) {
            ...
            var e, n, r, i = t.U,
                o = t.L,
                s = t.R;
            if (n = o ? s ? ea(s) : o : s, i ? i.L === t ? i.L = n : i.R = n : this._ = n, o && s ? (r = n.C, n.C = t.C, n.L = o, o.U = n, n !== s ? (i = n.U, n.U = t.U, t = n.R, i.L = t, n.R = s, s.U = n) : (n.U = i, i = n, t = n.R)) : (r = t.C, t = n), t && (t.U = i), !r)
                if (t && t.C) t.C = !1;
                else {
                    do {
                        if (t === this._) break;
    ...
    function Ma(t, e) {
        ...
        for (Sa = [], Ia = new Array(t.length), wa = new Ks, Na = new Ks;;)
            if (i = ca, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x)) o[0] === n && o[1] === r || (xa(o), n = o[0], r = o[1]), o = t.pop();
            else {
                if (!i) break;
                ma(i.arc)
            }
                ...
                value: function(t, e, n) {
                    ...
                    for (var f = new du(ku.compare), g = 0, d = r.length; g < d; g++)
                        for (var y = r[g].getSweepEvents(), v = 0, _ = y.length; v < _; v++)
                            if (f.insert(y[v]), f.size > Hu) throw new Error("Infinite loop when putting segment endpoints in a priority queue (queue size too big). Please file a bug report.");
    ...
    Gl.prototype.interfaces_ = function() {
        ...
        else if (3 === arguments.length && (t = arguments[0], n = arguments[2], !(e = arguments[1]).equals(t))) throw new kl("Expected " + t + " but encountered " + e + (null !== n ? ": " + n : ""))
    };
    var ql = function() {
    ...
    rc.prototype.add = function() {}, rc.prototype.addAll = function() {}, rc.prototype.isEmpty = function() {}, rc.prototype.iterator = function() {}, rc.prototype.size = function() {}, rc.prototype.toArray = function() {}, rc.prototype.remove = function() {}, ic.prototype = new Error, ic.prototype.name = "IndexOutOfBoundsException";
    var oc = function() {};
    ...
    pc.ForwardComparator.get = function() {
        ...
        if (5 === arguments.length)
            for (var r = arguments[0], i = arguments[1], o = arguments[2], s = arguments[3], a = arguments[4], u = 0; u < a; u++) o[s + u] = new al(r[i + u])
    ...
    var dc = function() {};
    dc.prototype.get = function() {}, dc.prototype.put = function() {}, dc.prototype.size = function() {}, dc.prototype.values = function() {}, dc.prototype.entrySet = function() {};
    var yc = function(t) {
        function e() {
            t.apply(this, arguments)
        }
    ...
    var Dc = function() {};
    Dc.prototype.filter = function(t, e) {}, Dc.prototype.isDone = function() {}, Dc.prototype.isGeometryChanged = function() {}, Dc.prototype.interfaces_ = function() {
        return []
    ...
    var Yh = function() {
        if (this._edges = new uc, this._nodes = null, this._edgeEndList = new uc, 0 === arguments.length) this._nodes = new Bh(new Xh);
        else if (1 === arguments.length) {
            var t = arguments[0];
    ...
    var Qh = function() {};
    Qh.prototype.insert = function(t, e) {}, Qh.prototype.remove = function(t, e) {}, Qh.prototype.query = function() {}, Qh.prototype.interfaces_ = function() {
        return []
    ...
    var fp = function() {};
    fp.prototype.getCoordinates = function() {}, fp.prototype.size = function() {}, fp.prototype.getCoordinate = function(t) {}, fp.prototype.isClosed = function() {}, fp.prototype.setData = function(t) {}, fp.prototype.getData = function() {}, fp.prototype.interfaces_ = function() {
        return []
    ...
    var Ep = function() {};
    Ep.prototype.computeNodes = function(t) {}, Ep.prototype.getNodedSubstrings = function() {}, Ep.prototype.interfaces_ = function() {
        return []
    ...
    Tp.prototype.addNextSegment = function(t, e) {
        ...
        else if (this._hasNarrowConcaveAngle = !0, this._offset0.p1.distance(this._offset1.p0) < this._distance * Tp.INSIDE_TURN_VERTEX_SNAP_DISTANCE_FACTOR) this._segList.addPt(this._offset0.p1);
        else {
    ...
    Vp.prototype.getNextCW = function(t) {
        ...
        for (var e = [!1, !1], n = this.iterator(); n.hasNext();)
            for (var r = n.next().getLabel(), i = 0; i < 2; i++) r.isLine(i) && r.getLocation(i) === hl.BOUNDARY && (e[i] = !0);
    ...
    var Jp = function() {};
    Jp.prototype.processIntersections = function(t, e, n, r) {}, Jp.prototype.isDone = function() {}, Jp.prototype.interfaces_ = function() {
        return []
    }, Jp.prototype.getClass = function() {
        return Jp
    };
    ...
    xf.prototype.interfaces_ = function() {
        ...
        if (arguments[2] instanceof mf && arguments[0] instanceof Jc && arguments[1] instanceof al)
            for (var t = arguments[0], e = arguments[1], n = arguments[2], r = t.getCoordinates(), i = new yp, o = 0; o < r.length - 1; o++) {
    ...
    Af.prototype.interfaces_ = function() {
        ...
        if (arguments[2] instanceof Tf && arguments[0] instanceof Jc && arguments[1] instanceof al)
            for (var t = arguments[0], e = arguments[1], n = arguments[2], r = new yp, i = t.getCoordinates(), o = 0; o < i.length - 1; o++) {
                    ...
                    polygonEnd: function() {
                        ...
                        var t = function(t, e) {
                            ...
                            for (var a = 0, u = t.length; a < u; ++a)
                                if (c = (l = t[a]).length)
                                    for (var l, c, h = l[c - 1], p = h[0], f = h[1] / 2 + Xg, g = $g(f), d = Qg(f), y = 0; y < c; ++y, p = _, g = x, d = E, h = v) {
                                        var v = l[y],
                                            _ = v[0],
                                            m = v[1] / 2 + Xg,
                                            x = $g(m),
    ...
    var Vd = zd((function() {
        ...
        var i;
        if (null == t) i = n * Vg, r.point(-Ug, i), r.point(0, i), r.point(Ug, i), r.point(Ug, 0), r.point(Ug, -i), r.point(0, -i), r.point(-Ug, -i), r.point(-Ug, 0), r.point(-Ug, i);
        ...
        return zd(o, (function(t) {
            ...
            return {
                ...
                point: function(h, p) {
                    ...
                    if (!e && (l = u = d) && t.lineStart(), d !== u && (!(f = s(e, g)) || wd(e, f) || wd(g, f)) && (g[0] += jg, g[1] += jg, d = o(g[0], g[1])), d !== u) c = 0, d ? (t.lineStart(), f = s(g, e), t.point(f[0], f[1])) : (f = s(e, g), t.point(f[0], f[1]), t.lineEnd()), e = f;
                    else if (i && e && r ^ d) {
                        var v;
    ...
    function Qd(t) {
        return function(t) {
            ...
            return N.stream = function(t) {
                    ...
                    return arguments.length ? (b = null == t ? (E = s = a = u = null, Dd) : Td(E = +t[0][0], s = +t[0][1], a = +t[1][0], u = +t[1][1]), L()) : null == E ? null : [
                        [E, s],
                        [a, u]
                    ]
                }, N.scale = function(t) {
                ...
                for (b.sort((function(t, e) {
                    ...
                    for (; !ai(p[P].coord, p[D].coord);) {
                        ...
                        if (null != F && b.splice(F, 1), ai(A, p[D].ringAndEdge1)) {
                            ...
                            isect: D
                        }, oi([p[T].coord, p[D].coord, p[p[D].nxtIsectAlongRingAndEdge1].coord], 1 == M) ? (k.parent = L, k.winding = -M) : (k.parent = O, k.winding = M), b.push(k)), T = D, D = p[D].nxtIsectAlongRingAndEdge1
                    }
